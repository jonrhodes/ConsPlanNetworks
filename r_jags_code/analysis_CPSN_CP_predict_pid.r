...
NUMPN <- c(3)
PIDPRED <- seq(0.1,1,0.1)
NUMPID <- c(10)

#standardise
NSTPRED <- (NSTPRED - mean(NST)) / sd(NST)
PIDPRED <- (PIDPRED - mean(PID)) / sd(PID)
...
#complie data
DataStar <- list(NUMBR=NUMBR,N=N,SC=SC,TAUSC=TAUSC,NST=NST,PIR=PIR,PID=PID,BR=BR,NUMPN=NUMPN,NUMPID=NUMPID,NSTPRED=NSTPRED,PIDPRED=PIDPRED)
...
#complie data
DataLine <- list(NUMBR=NUMBR,N=N,SC=SC,TAUSC=TAUSC,NST=NST,PIR=PIR,PID=PID,BR=BR,NUMPN=NUMPN,NUMPID=NUMPID,NSTPRED=NSTPRED,PIDPRED=PIDPRED)
...
#complie data
DataWheel <- list(NUMBR=NUMBR,N=N,SC=SC,TAUSC=TAUSC,NST=NST,PIR=PIR,PID=PID,BR=BR,NUMPN=NUMPN,NUMPID=NUMPID,NSTPRED=NSTPRED,PIDPRED=PIDPRED)
...
#complie data
DataRing <- list(NUMBR=NUMBR,N=N,SC=SC,TAUSC=TAUSC,NST=NST,PIR=PIR,PID=PID,BR=BR,NUMPN=NUMPN,NUMPID=NUMPID,NSTPRED=NSTPRED,PIDPRED=PIDPRED)
...
#complie data
DataRingStar <- list(NUMBR=NUMBR,N=N,SC=SC,TAUSC=TAUSC,NST=NST,PIR=PIR,PID=PID,BR=BR,NUMPN=NUMPN,NUMPID=NUMPID,NSTPRED=NSTPRED,PIDPRED=PIDPRED)
...
#complie data
DataRingLine <- list(NUMBR=NUMBR,N=N,SC=SC,TAUSC=TAUSC,NST=NST,PIR=PIR,PID=PID,BR=BR,NUMPN=NUMPN,NUMPID=NUMPID,NSTPRED=NSTPRED,PIDPRED=PIDPRED)
...
#complie data
DataStarLine <- list(NUMBR=NUMBR,N=N,SC=SC,TAUSC=TAUSC,NST=NST,PIR=PIR,PID=PID,BR=BR,NUMPN=NUMPN,NUMPID=NUMPID,NSTPRED=NSTPRED,PIDPRED=PIDPRED)
...
Jags.Fits <- sfLapply(data,get.jags1.pred.pid)
...
#save output
save(Jags.Fits,file="Jags_Fits_PredPID.RData")
