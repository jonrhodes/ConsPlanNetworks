...
#analyse communities
MatFileExpW95 <- readMat("M:/Users/uqjrhode/work/networks_cons_plan/spudd_final_run/ConsMDP/results/ExpRc_FisheryWeights95Model3pr0.2pd0.2.mat")
MatFileExpNW95 <- readMat("M:/Users/uqjrhode/work/networks_cons_plan/spudd_final_run/ConsMDP/results/ExpRc_FisheryNoWeights95Model3pr0.2pd0.2.mat")
MatFileExpW80 <- readMat("M:/Users/uqjrhode/work/networks_cons_plan/spudd_final_run/ConsMDP/results/ExpRc_FisheryWeights80Model3pr0.2pd0.2.mat")
MatFileExpNW80 <- readMat("M:/Users/uqjrhode/work/networks_cons_plan/spudd_final_run/ConsMDP/results/ExpRc_FisheryNoWeights80Model3pr0.2pd0.2.mat")
MatFileExpW50 <- readMat("M:/Users/uqjrhode/work/networks_cons_plan/spudd_final_run/ConsMDP/results/ExpRc_FisheryWeights50Model3pr0.2pd0.2.mat")
MatFileExpNW50 <- readMat("M:/Users/uqjrhode/work/networks_cons_plan/spudd_final_run/ConsMDP/results/ExpRc_FisheryNoWeights50Model3pr0.2pd0.2.mat")

BenefitW95 <- ((MatFileExpW95$ExpRc[,,,1]/MatFileExpW95$ExpRc[,,,2]) - 1) * 100
BenefitW80 <- ((MatFileExpW80$ExpRc[,,,1]/MatFileExpW80$ExpRc[,,,2]) - 1) * 100
BenefitW50 <- ((MatFileExpW50$ExpRc[,,,1]/MatFileExpW50$ExpRc[,,,2]) - 1) * 100
BenefitNW95 <- ((MatFileExpNW95$ExpRc[,,,1]/MatFileExpNW95$ExpRc[,,,2]) - 1) * 100
BenefitNW80 <- ((MatFileExpNW80$ExpRc[,,,1]/MatFileExpNW80$ExpRc[,,,2]) - 1) * 100
BenefitNW50 <- ((MatFileExpNW50$ExpRc[,,,1]/MatFileExpNW50$ExpRc[,,,2]) - 1) * 100
...
paste("M:/Users/uqjrhode/work/networks_cons_plan/spudd_final_run/ConsMDP/results/ExpRc_starModel3nSites6NumSp",NumSpec[i],"Occ",Occ[j],"Nested",Nested[k],"pr0.2pd0.2.mat",sep=""))
