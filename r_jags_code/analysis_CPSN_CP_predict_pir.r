...
#get the prediction vectors for the predictor variables
NSTPRED <- c(0.1,0.5,0.9)
NUMPN <- c(3)
PIRPRED <- seq(0.1,1,0.1)
NUMPIR <- c(10)

#standardise
NSTPRED <- (NSTPRED - mean(NST)) / sd(NST)
PIRPRED <- (PIRPRED - mean(PIR)) / sd(PIR)
...
#complie data
DataStar <- list(NUMBR=NUMBR,N=N,SC=SC,TAUSC=TAUSC,NST=NST,PIR=PIR,PID=PID,BR=BR,NUMPN=NUMPN,NUMPIR=NUMPIR,NSTPRED=NSTPRED,PIRPRED=PIRPRED)
...
#complie data
DataLine <- list(NUMBR=NUMBR,N=N,SC=SC,TAUSC=TAUSC,NST=NST,PIR=PIR,PID=PID,BR=BR,NUMPN=NUMPN,NUMPIR=NUMPIR,NSTPRED=NSTPRED,PIRPRED=PIRPRED)
...
#complie data
DataWheel <- list(NUMBR=NUMBR,N=N,SC=SC,TAUSC=TAUSC,NST=NST,PIR=PIR,PID=PID,BR=BR,NUMPN=NUMPN,NUMPIR=NUMPIR,NSTPRED=NSTPRED,PIRPRED=PIRPRED)
...
#complie data
DataRing <- list(NUMBR=NUMBR,N=N,SC=SC,TAUSC=TAUSC,NST=NST,PIR=PIR,PID=PID,BR=BR,NUMPN=NUMPN,NUMPIR=NUMPIR,NSTPRED=NSTPRED,PIRPRED=PIRPRED)
...
#complie data
DataRingStar <- list(NUMBR=NUMBR,N=N,SC=SC,TAUSC=TAUSC,NST=NST,PIR=PIR,PID=PID,BR=BR,NUMPN=NUMPN,NUMPIR=NUMPIR,NSTPRED=NSTPRED,PIRPRED=PIRPRED)
...
#complie data
DataRingLine <- list(NUMBR=NUMBR,N=N,SC=SC,TAUSC=TAUSC,NST=NST,PIR=PIR,PID=PID,BR=BR,NUMPN=NUMPN,NUMPIR=NUMPIR,NSTPRED=NSTPRED,PIRPRED=PIRPRED)
...
#complie data
DataStarLine <- list(NUMBR=NUMBR,N=N,SC=SC,TAUSC=TAUSC,NST=NST,PIR=PIR,PID=PID,BR=BR,NUMPN=NUMPN,NUMPIR=NUMPIR,NSTPRED=NSTPRED,PIRPRED=PIRPRED)
...
Jags.Fits <- sfLapply(data,get.jags1.pred.pir)
...
#save output
save(Jags.Fits,file="Jags_Fits_PredPIR.RData")
