get.jags1 <- function(Data)
{
	...
	fit <- run.jags(model="M:/Users/uqjrhode/work/networks_cons_plan/code/jags_model1.txt",monitor=c("alpha","nst","sa","alpir","nspir","spir","alpid","nspid","spid","sd"),data=Data,n.chains=3,inits=list(inits1,inits2,inits3),burnin=20000,adapt=1000,sample=20000,jags="C:/Program Files/JAGS/JAGS-4.2.0/x64/bin/jags-terminal.exe",method="rjparallel",cl=cl)
...
get.jags1.pred.pid <- function(Data)
{
	#get initial values
	inits1 <- list(alpha=runif(1,-10,10),nst=runif(1,-10,10),alpir=runif(1,-10,10),nspir=runif(1,0,10),spir=runif(1,0,10),alpid=runif(1,-10,10),nspid=runif(1,0,10),spid=runif(1,0,10),sd=runif(1,0,10),TrueSC=runif(Data$N,-10,10))
	inits2 <- list(alpha=runif(1,-10,10),nst=runif(1,-10,10),alpir=runif(1,-10,10),nspir=runif(1,0,10),spir=runif(1,0,10),alpid=runif(1,-10,10),nspid=runif(1,0,10),spid=runif(1,0,10),sd=runif(1,0,10),TrueSC=runif(Data$N,-10,10))
	...
	fit <- run.jags(model="M:/Users/uqjrhode/work/networks_cons_plan/code/jags_model1_predict_pid.txt",monitor=c("pred"),data=Data,n.chains=3,inits=list(inits1,inits2,inits3),burnin=20000,adapt=1000,sample=20000,jags="C:/Program Files/JAGS/JAGS-4.2.0/x64/bin/jags-terminal.exe",method="rjparallel",cl=cl)
...
get.jags1.pred.pir <- function(Data)
{
	#get initial values
	inits1 <- list(alpha=runif(1,-10,10),nst=runif(1,-10,10),alpir=runif(1,-10,10),nspir=runif(1,0,10),spir=runif(1,0,10),alpid=runif(1,-10,10),nspid=runif(1,0,10),spid=runif(1,0,10),sd=runif(1,0,10),TrueSC=runif(Data$N,-10,10))
	inits2 <- list(alpha=runif(1,-10,10),nst=runif(1,-10,10),alpir=runif(1,-10,10),nspir=runif(1,0,10),spir=runif(1,0,10),alpid=runif(1,-10,10),nspid=runif(1,0,10),spid=runif(1,0,10),sd=runif(1,0,10),TrueSC=runif(Data$N,-10,10))
	...
	fit <- run.jags(model="M:/Users/uqjrhode/work/networks_cons_plan/code/jags_model1_predict_pir.txt",monitor=c("pred"),data=Data,n.chains=3,inits=list(inits1,inits2,inits3),burnin=20000,adapt=1000,sample=20000,jags="C:/Program Files/JAGS/JAGS-4.2.0/x64/bin/jags-terminal.exe",method="rjparallel",cl=cl)
