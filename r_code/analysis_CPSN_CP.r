# This is the R code to calculate the value of information for the simulations and run the regression models
...
for (i in 1:length(NumSpec))
{
	...
	for (j in 1:length(Occ))
	{
		...
		for (k in 1:length(Nested))
		{
			...
			MatFileExp <- readMat(paste("../problems/ConsMDP/results/ExpRc_starModel3nSites6NumSp",NumSpec[i],"Occ",Occ[j],"Nested",Nested[k],"pr0.2pd0.2.mat",sep=""))
			MatFileSD <- readMat(paste("../problems/ConsMDP/results/SDRc_starModel3nSites6NumSp",NumSpec[i],"Occ",Occ[j],"Nested",Nested[k],"pr0.2pd0.2.mat",sep=""))
...
for (i in 1:length(NumSpec))
{
	...
	for (j in 1:length(Occ))
	{
		...
		for (k in 1:length(Nested))
		{
			...
			#get the right .mat file
			# dimensions = [pir,pid,rep_id(BR replicate),method(1=CPSN,2=CP,3=SN,4=RND),number simulations] - no number simulations in the expectation and SD files
			MatFileExp <- readMat(paste("../problems/ConsMDP/results/ExpRc_lineModel3nSites6NumSp",NumSpec[i],"Occ",Occ[j],"Nested",Nested[k],"pr0.2pd0.2.mat",sep=""))
			MatFileSD <- readMat(paste("../problems/ConsMDP/results/SDRc_lineModel3nSites6NumSp",NumSpec[i],"Occ",Occ[j],"Nested",Nested[k],"pr0.2pd0.2.mat",sep=""))
...
for (i in 1:length(NumSpec))
{
	...
	for (j in 1:length(Occ))
	{
		...
		for (k in 1:length(Nested))
		{
			...
			#get the right .mat file
			# dimensions = [pir,pid,rep_id(BR replicate),method(1=CPSN,2=CP,3=SN,4=RND),number simulations] - no number simulations in the expectation and SD files
			MatFileExp <- readMat(paste("../problems/ConsMDP/results/ExpRc_wheelModel3nSites6NumSp",NumSpec[i],"Occ",Occ[j],"Nested",Nested[k],"pr0.2pd0.2.mat",sep=""))
			MatFileSD <- readMat(paste("../problems/ConsMDP/results/SDRc_wheelModel3nSites6NumSp",NumSpec[i],"Occ",Occ[j],"Nested",Nested[k],"pr0.2pd0.2.mat",sep=""))
...
for (i in 1:length(NumSpec))
{
	...
	for (j in 1:length(Occ))
	{
		...
		for (k in 1:length(Nested))
		{
			...
			#get the right .mat file
			# dimensions = [pir,pid,rep_id(BR replicate),method(1=CPSN,2=CP,3=SN,4=RND),number simulations] - no number simulations in the expectation and SD files
			MatFileExp <- readMat(paste("../problems/ConsMDP/results/ExpRc_islandModel3nSites6NumSp",NumSpec[i],"Occ",Occ[j],"Nested",Nested[k],"pr0.2pd0.2.mat",sep=""))
			MatFileSD <- readMat(paste("../problems/ConsMDP/results/SDRc_islandModel3nSites6NumSp",NumSpec[i],"Occ",Occ[j],"Nested",Nested[k],"pr0.2pd0.2.mat",sep=""))
...
for (i in 1:length(NumSpec))
{
	...
	for (j in 1:length(Occ))
	{
		...
		for (k in 1:length(Nested))
		{
			...
			#get the right .mat file
			# dimensions = [pir,pid,rep_id(BR replicate),method(1=CPSN,2=CP,3=SN,4=RND),number simulations] - no number simulations in the expectation and SD files
			MatFileExp <- readMat(paste("../problems/ConsMDP/results/ExpRc_islandstarModel3nSites6NumSp",NumSpec[i],"Occ",Occ[j],"Nested",Nested[k],"pr0.2pd0.2.mat",sep=""))
			MatFileSD <- readMat(paste("../problems/ConsMDP/results/SDRc_islandstarModel3nSites6NumSp",NumSpec[i],"Occ",Occ[j],"Nested",Nested[k],"pr0.2pd0.2.mat",sep=""))
...
#run jags model
#combine data
data <- list(DataStar,DataLine,DataRing,DataWheel,DataRingStar)
