        ...
        for ipid=1:length(pid) %loop over pid
            for meth=1:length(sol_methods) %loop over the methods
                ...
                if strcmp(sol_methods{meth},'CPSN') %conservation planning and social network
                    ...
                    pol_file=['../problems/ConsMDP/',Shape,'/',filename,'-OPTpolicy.dot'];
...
save(['../problems/ConsMDP/','results/ExpR_',Shape,'Model',num2str(Model),'nSites',num2str(n_sites),'NumSp',num2str(n_species),'Occ',num2str(p_occurrence),'Nested',num2str(Nested),'pr',num2str(pr),'pd',num2str(pd),'.mat'],'ExpR');
save(['../problems/ConsMDP/','results/SDR_',Shape,'Model',num2str(Model),'nSites',num2str(n_sites),'NumSp',num2str(n_species),'Occ',num2str(p_occurrence),'Nested',num2str(Nested),'pr',num2str(pr),'pd',num2str(pd),'.mat'],'SDR');
save(['../problems/ConsMDP/','results/ExpRc_',Shape,'Model',num2str(Model),'nSites',num2str(n_sites),'NumSp',num2str(n_species),'Occ',num2str(p_occurrence),'Nested',num2str(Nested),'pr',num2str(pr),'pd',num2str(pd),'.mat'],'ExpRc');
save(['../problems/ConsMDP/','results/SDRc_',Shape,'Model',num2str(Model),'nSites',num2str(n_sites),'NumSp',num2str(n_species),'Occ',num2str(p_occurrence),'Nested',num2str(Nested),'pr',num2str(pr),'pd',num2str(pd),'.mat'],'SDRc');
