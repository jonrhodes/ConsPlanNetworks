...
parpool(2); %run in parallel - modify number of cores here if necessary
    ...
    for ipid=1:length(pid) %loop over pid
        for meth=1:2 %loop over the methods - in this case it is just CPSN and SN
            ...
            if meth==1 %conservation planning and social network
                ...
                pol_file=['../problems/ConsMDP/fishery/',filename,'-OPTpolicy.dot'];
...
save(['../problems/ConsMDP/','results/ExpR_FisheryWeights',SpecPerc,'Model',num2str(3),'pr',num2str(pr),'pd',num2str(pd),'.mat'],'ExpR');
save(['../problems/ConsMDP/','results/SDR_FisheryWeights',SpecPerc,'Model',num2str(3),'pr',num2str(pr),'pd',num2str(pd),'.mat'],'SDR');
save(['../problems/ConsMDP/','results/ExpRc_FisheryWeights',SpecPerc,'Model',num2str(3),'pr',num2str(pr),'pd',num2str(pd),'.mat'],'ExpRc');
save(['../problems/ConsMDP/','results/SDRc_FisheryWeights',SpecPerc,'Model',num2str(3),'pr',num2str(pr),'pd',num2str(pd),'.mat'],'SDRc');
...
save(['../problems/ConsMDP/','results/ExpR_FisheryNoWeights',SpecPerc,'Model',num2str(3),'pr',num2str(pr),'pd',num2str(pd),'.mat'],'ExpR');
save(['../problems/ConsMDP/','results/SDR_FisheryNoWeights',SpecPerc,'Model',num2str(3),'pr',num2str(pr),'pd',num2str(pd),'.mat'],'SDR');
save(['../problems/ConsMDP/','results/ExpRc_FisheryNoWeights',SpecPerc,'Model',num2str(3),'pr',num2str(pr),'pd',num2str(pd),'.mat'],'ExpRc');
save(['../problems/ConsMDP/','results/SDRc_FisheryNoWeights',SpecPerc,'Model',num2str(3),'pr',num2str(pr),'pd',num2str(pd),'.mat'],'SDRc');
