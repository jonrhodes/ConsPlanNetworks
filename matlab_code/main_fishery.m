...
param.n_simu = 1000000; %number of simulations for each network, BR and solution methods

%solve with and without weights - note we used the weights version in the paper
solve_fishery(param,0);
solve_fishery(param,1);

%evaluate
evaluate_par_fishery(param);
